          ...
          <Col span={24}>
            ...
            >
              ...
              <div>
                {props.items[i].usuario && (
                  <Space wrap>
                    <div style={{ paddingTop: "10px" }}>Cita no realizada</div>
                  </Space>
                )}
              </div>
              <div
...
function Component() {
  ...
  useEffect(() => {
    (async () => {
      const d = await axios.get(
        import.meta.env.VITE_COUCH_IP + "/citas/_all_docs?include_docs=true",
        {
          auth: {
  ...
  const changeData = async (e: any, c: any) => {
    ...
    let n = await axios.put(
      import.meta.env.VITE_COUCH_IP + "/citas/" + import.meta.env.VITE_COUCH_ID,
      {
        _rev: data._rev,
        ...items,
      },
    ...
    <div className={styles.component}>
      ...
      {data && (
        <Schedule
          ...
          day={currentDay}
          onChangeData={_changeData}
        />
      )}
      <Modal
        title="Actualice información"
